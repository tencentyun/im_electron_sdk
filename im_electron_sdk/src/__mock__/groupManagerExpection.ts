...
export const createGroupResult = JSON.stringify({
    ...
    create_group_param_group_member_array: [{
        ...
        group_member_info_custom_info: [{ group_member_info_custom_string_info_key: 'test key 1', group_member_info_custom_string_info_value: 'test value1' }]
    }],
    ...
    create_group_param_custom_info: [{ group_info_custom_string_info_key: 'test key', group_info_custom_string_info_value: 'test value' }]
});
