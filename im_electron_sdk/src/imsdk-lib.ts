...
const Imsdklib = ffi.Library(ffiPath,{
      ...
      "TIMMsgRevoke": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      ...
      "TIMMsgSaveMsg": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgGetMsgList": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgDelete": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgListDelete": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgClearHistoryMessage": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgSetC2CReceiveMessageOpt": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgGetC2CReceiveMessageOpt": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgSetGroupReceiveMessageOpt": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgDownloadElemToPath": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
