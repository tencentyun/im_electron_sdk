...
const Imsdklib = ffi.Library(ffiPath,{
      ...
      "TIMFriendshipAddFriend": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipHandleFriendAddRequest": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipModifyFriendProfile": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipDeleteFriend": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipCheckFriendType": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipCreateFriendGroup": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipGetFriendGroupList": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipModifyFriendGroup": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipDeleteFriendGroup": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipAddToBlackList": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipGetBlackList": [ref.types.int, ['pointer', ref.types.CString]],
      "TIMFriendshipDeleteFromBlackList": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipGetPendencyList": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipDeletePendency": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipReportPendencyReaded": [ref.types.int, [ref.types.uint64, 'pointer', ref.types.CString]],
      "TIMFriendshipSearchFriends": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMFriendshipGetFriendsInfo": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgSendMessage": [ref.types.int, [ref.types.CString, ref.types.int, ref.types.CString, ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgCancelSend": [ref.types.int, [ref.types.CString, ref.types.int, ref.types.CString, 'pointer', ref.types.CString]],
      ...
      "TIMMsgFindByMsgLocatorList": [ref.types.int, [ref.types.CString, ref.types.int, ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgImportMsgList": [ref.types.int, [ref.types.CString, ref.types.int, ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgSaveMsg": [ref.types.int, [ref.types.CString, ref.types.int, ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgGetMsgList": [ref.types.int, [ref.types.CString, ref.types.int, ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgDelete": [ref.types.int, [ref.types.CString, ref.types.int, ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgListDelete": [ref.types.int, [ref.types.CString, ref.types.int, ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgClearHistoryMessage": [ref.types.int, [ref.types.CString, ref.types.int, 'pointer', ref.types.CString]],
      "TIMMsgSetC2CReceiveMessageOpt": [ref.types.int, [ref.types.CString, ref.types.int, 'pointer', ref.types.CString]],
      "TIMMsgGetC2CReceiveMessageOpt": [ref.types.int, [ref.types.CString, 'pointer', ref.types.CString]],
      "TIMMsgSetGroupReceiveMessageOpt": [ref.types.int, [ref.types.CString, ref.types.int, 'pointer', ref.types.CString]],
